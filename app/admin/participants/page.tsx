...
export default async function ParticipantsPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return (
    <main className="px-5 py-8 sm:px-10">
      ...
      <form className="my-7 grid gap-3 border border-[var(--line)] bg-white/30 p-3 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <div className="overflow-x-auto border border-[var(--line)]">
        <table className="w-full min-w-[820px] border-collapse text-sm">
          <thead className="bg-[var(--ink)] text-left text-xs uppercase tracking-[0.12em] text-[var(--paper)]"><tr><th className="p-4">Participant</th><th className="p-4">Study</th><th className="p-4">Status</th><th className="p-4">Consent</th><th className="p-4">Locale / Region</th><th className="p-4">Signals</th></tr></thead>
          <tbody>
