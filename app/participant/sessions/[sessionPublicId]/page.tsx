...
export default async function SessionMarkerPage({ params }: { params: Promise<{ sessionPublicId: string }> }) {
  ...
  return (
    <main className="content-page max-w-3xl">
      <div className="flex justify-between gap-4"><Link href="/participant/tasks" className="secondary-action">← 我的任务</Link><Link href="/participant/uploads" className="primary-action">上传文件 → <UploadSimple className="size-4" /></Link></div>
