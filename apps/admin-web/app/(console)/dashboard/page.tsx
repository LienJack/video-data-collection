  ...
  return (
    <main className="app-page">
      ...
      <section className="mt-10 grid gap-4 xl:grid-cols-[1.25fr_0.75fr]">
        ...
        <Link href="/uploads" className="surface flex min-h-64 flex-col justify-between p-7 sm:p-9">
      ...
      <section className="surface mt-4 p-6 sm:p-8">
        <div className="flex justify-between gap-4"><div><p className="page-kicker">Append-only</p><h2 className="display mt-1 text-2xl font-semibold">最近审计</h2></div><Link href="/audit" className="secondary-action">查看全部 <ArrowRight className="size-4" /></Link></div>
