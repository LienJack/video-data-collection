...
下图从管理员和参与者两个视角概括一次第一人称视频采集的任务创建、现场拍摄、断点上传与审核闭环：

![管理员与参与者完成一次第一人称视频拍摄与上传的业务流程](docs/images/video-collection-workflow.webp)

> 二维码当前只用于录制现场标记；上传时仍由参与者为每个文件手动选择拍摄会话。
